...
## Set WD ##
setwd("C:/Users/CM8738/Dropbox/RGU/Teaching/2024-2025/Sem 1/CM4125 - Data Viz/CM4125 T10")
...
sankey2<- sankeyNetwork(Links = data_long_3cols, Nodes = nodes_3cols,
                        ...
                        sinksRight=FALSE, nodeWidth=40, fontSize=13, 
                        nodePadding=20, iterations=0)
sankey2 # Note that at this point we cannot know gender/diet change relation. For that, we would need to invert the order!
